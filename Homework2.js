...
c = ++a;  // c = 2, оператор инкремента на 1 увеличивает значение переменной на 1;
//alert(c);
window.console.log("c = ++a; - "+c);

d = b++; // d = 2, оператор инкремента на 1 увеличивает значение переменной на 1;
//alert(d);
window.console.log("d = b++; - "+d);

c = (2 + ++a);  // c = 5, префиксный оператор инкремента возвращает значение переменной + 1; 
//alert(c);
